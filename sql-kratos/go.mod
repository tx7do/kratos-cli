...
replace (
	github.com/tx7do/kratos-cli/sql-orm v0.0.0-20250603005442-0ab3936e8ce6 => ../sql-orm
	github.com/tx7do/kratos-cli/sql-proto v0.0.0-20250603005442-0ab3936e8ce6 => ../sql-proto
)
